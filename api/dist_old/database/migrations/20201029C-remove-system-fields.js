...
function up(knex) {
    return __awaiter(this, void 0, void 0, function* () {
        const fieldKeys = lodash_1.uniq(systemFields.map((field) => field.field));
        yield knex('directus_fields').delete().where('collection', 'like', 'directus_%').whereIn('field', fieldKeys);
    });
}
exports.up = up;
function down(knex) {
    return __awaiter(this, void 0, void 0, function* () {
        yield knex.insert(systemFields).into('directus_fields');
    });
}
exports.down = down;
