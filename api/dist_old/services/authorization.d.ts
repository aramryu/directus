import { Accountability, AbstractServiceOptions, AST, PermissionsAction, Item, PrimaryKey, SchemaOverview } from '../types';
...
export declare class AuthorizationService {
    ...
    validateJoi(validation: null | Record<string, any>, payloads: Partial<Record<string, any>>[]): FailedValidationException[];
