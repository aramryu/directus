...
validate_env_1.validateEnv(['STORAGE_LOCATIONS']);
...
function getStorageConfig() {
    ...
    const locations = to_array_1.toArray(env_1.default.STORAGE_LOCATIONS);
    locations.forEach((location) => {
        location = location.trim();
        const diskConfig = {
            driver: env_1.default[`STORAGE_${location.toUpperCase()}_DRIVER`],
            config: get_config_from_env_1.getConfigFromEnv(`STORAGE_${location.toUpperCase()}_`),
        };
