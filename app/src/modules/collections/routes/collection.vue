			...
			<div class="bookmark-controls">
				...
				>
					<template #activator="{ on }">
						<d-icon class="toggle" @click="on" name="bookmark_outline" v-tooltip.right="$t('create_bookmark')" />
					</template>
				</bookmark-add>
				...
				<template v-else-if="bookmarkIsMine">
					<d-icon class="save" @click="savePreset()" name="bookmark_save" v-tooltip.bottom="$t('update_bookmark')" />
				</template>
				...
				>
					<template #activator="{ on }">
						<d-icon class="toggle" name="bookmark_outline" @click="on" />
					</template>
				</bookmark-add>
